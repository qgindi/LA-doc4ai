...
Class[File](🔗) reads/writes simple text or raw binary data.
...
If the file already exists, the `WriteX`functions overwrite (replace) it, else they create new file.
The`AppendX` functions append to existing file or create new file.
