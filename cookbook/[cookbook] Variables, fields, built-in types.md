...
[Variables](🔗) are containers for storing numbers, text and other data. A variable has a type, name and value.
...
Variables declared in functions or directly in script are *local variables*. Function *parameters*too.
Variables declared directly in a class are known as*fields*. [More info](🔗).
