...
- Add panels and toolbars. To run at startup, add the script name in **Options > Workspace > Startup scripts**. These menus and toolbars cannot be customized in menu **Tools > Customize**.
