...
Class `FileSystemWatcher` detects filesystem changes in a directory, when a file or subdirectory created, deleted, renamed, modified, changed attributes/times/size.

See also recipe [wait for file](Wait%20for%20file.html). It contains an example of how to load a created or modified file. See also recipe [Other triggers](Other%20triggers.html).
