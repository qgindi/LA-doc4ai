...
This example uses library [HandyControl](https://www.google.com/search?q=HandyControl). NuGet: HandyControl. Applies its theme to all controls and adds several its controls to the dialog.
