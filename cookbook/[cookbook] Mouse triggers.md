...
To execute some code or run a script, can be used mouse [triggers](🔗). Examples: `Alt`+click, `Shift`+wheel, touch a screen edge in certain area, mouse movements in certain area.
