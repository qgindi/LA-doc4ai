...
1. Use [keyboard triggers](🔗). It is the most flexible way. Less reliable, for example may not work in some windows.
...
Note: to remap keys use`keys.more.sendKey` or `keys.sendL`, not `keys.send`.
