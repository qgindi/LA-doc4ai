...
1. Let the editor program launch the script. [More info](🔗). Command line examples:
...
2. Run the script without the editor. For it need to [create exe program](🔗) from the script. Then launch it like any other program. Example:
