...
[Selenium WebDriver](🔗) can be used to automate pages in web browser. It has more features than `Au.elm` (see [Web automation](🔗)). For example can wait for web page loaded, extract text, execute JavaScript. But not so easy to use. Weaker than [Playwright](🔗).
