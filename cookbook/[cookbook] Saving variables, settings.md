...
The fastest possible way is to put the variables in a record class derived from`Au.Types.JSettings`. They will be automatically saved in a JSON file. Run this script two times to see how it works.
