...
For SQL Server databases use NuGet package Microsoft.Data.SqlClient. For other databases look for other [NuGet](🔗) packages. Look for more info+examples on the internet.
