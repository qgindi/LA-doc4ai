...
Use class [Random](🔗) to generate random numbers or data when speed is more important than quality.
...
If need random strings of other formats (eg certain set of characters), look on the internet, for example in [NuGet](🔗).