...
- **Print** - text to print in the output panel when inserting the snippet. Can contain [output tags](🔗) if starts with `<>`.
...
Snippet code can contain fields and variables, like in [VSCode](🔗).
