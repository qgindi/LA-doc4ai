...
LibreAutomate is like a new major version of [Quick Macros](🔗) (QM). It has most of QM features. But it is very different.
...
LibreAutomate can run on Windows 7-11 with .NET runtime. More info [here](🔗).
...
As you see, C# code is longer, but usually it is easier to understand. The [code editor](🔗) can add `; () { }` automatically as you type, and has other code editing features that are much better than in QM.
