...
The app does not have a dialog window editor/designer, but it's easy to create windows in code, using class `Au.wpfBuilder`. The app can automatically show/update the window while you edit its code, if it contains code like this:
