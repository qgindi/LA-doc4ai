...
Here you edit automation scripts and other text files.[Features](🔗).
...
- Simple folders.
- Folders named like `@Name` are [project](🔗) folders.
...
The app writes various info here. For example script compilation errors. Scripts use `Au.print.it` for it.
