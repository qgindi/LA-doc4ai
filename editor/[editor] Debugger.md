...
See cookbook article [Script testing and debugging](🔗).

## Debugger

Debugger in LibreAutomate is similar to that of [Visual Studio](🔗), [VSCode](🔗), [Rider](🔗) etc.
