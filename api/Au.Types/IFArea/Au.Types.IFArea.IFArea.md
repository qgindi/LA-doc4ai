...
Specifies a window or control and a rectangle in its client area.
The parameters are of`Au.Types.Coord` type, therefore can be easily specified reverse and fractional coordinates, like `^10` and `.5f`. Use `^0` for right or bottom edge.
