...
Examples of valid numbers:`"12"`, `" -12.3 "`, `".12"`, `"12."`, `"12E3"`, `"12.3e-45"`, `"1,234.5"` (with *style* `NumberStyles.Float | NumberStyles.AllowThousands`). String like `"2text"` is invalid, unless *range* is `0..1`.
...
Calls `ulong.TryParse` with `System.Globalization.CultureInfo.InvariantCulture`.