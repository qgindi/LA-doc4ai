...
If it identifies an existing file-system object (file or directory), returns path. If URL, returns URL. Else returns`":: ITEMIDLIST"` (see `Au.Types.Pidl.ToHexString`).
