...
Parameter type of `Au.keys.send`and similar functions.
Has implicit conversions from`string`, `Au.clipboardData`, `Au.Types.KKey`, `Au.Types.KKeyScan`, `char`, `int` (sleep time) and `System.Action`.
