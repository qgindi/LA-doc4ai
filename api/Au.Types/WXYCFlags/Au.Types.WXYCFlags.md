...
If the point is not in client area, don't look for descendants; if with flag `OrThis` and the point is in this (non-client area), return this, else return `default(wnd)`.
