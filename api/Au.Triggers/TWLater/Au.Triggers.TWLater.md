...
The window has been cloaked (`Au.wnd.IsCloaked` true).
...
Became invisible (`Au.wnd.IsVisible`false).
...
The window has been uncloaked (`Au.wnd.IsCloaked` false).
...
Became visible (`Au.wnd.IsVisible`true).
