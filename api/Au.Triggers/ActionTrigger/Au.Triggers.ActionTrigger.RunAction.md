...
This function must be called while the main triggers thread is in `Au.Triggers.ActionTriggers.Run`, for example from another trigger action. It is asynchronous (does not wait).
