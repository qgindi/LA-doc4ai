...
By default, only alpha-numeric characters (`char.IsLetterOrDigit` returns `true`) are considered word characters. You can use this property to add more word characters, for example `"_#"`.
