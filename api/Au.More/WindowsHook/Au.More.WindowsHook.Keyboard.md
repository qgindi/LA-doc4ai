...
- *hookProc*  (`Action<Au.Types.HookData.Au.Types.HookData.Keyboard>`):
  ...
  Must return as soon as possible. More info:`Au.More.WindowsHook.LowLevelHooksTimeout`.
  If calls`Au.Types.HookData.Keyboard.BlockEvent` or `Au.Types.HookData.ReplyMessage(true)`, the event is not sent to apps and other hooks.
