...
If need better accuracy, use a cloud OCR engine (`Au.More.OcrGoogleCloud`, `Au.More.OcrMicrosoftAzure`).
If need a non-cloud OCR for older Windows, install Tesseract and use`Au.More.OcrTesseract`. Also it supports more languages.
