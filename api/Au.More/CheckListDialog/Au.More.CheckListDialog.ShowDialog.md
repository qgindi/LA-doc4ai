...
- *owner*  (`DependencyObject`):
  ...
  If used, sets`System.Windows.Window.ShowInTaskbar` = `false`. Else sets `System.Windows.Window.Topmost` = `true`, unless `Au.dialog.options.topmostIfNoOwnerWindow` is `false` or the active window belongs to this process.
