...
Shows the main window, regardless of *activateWindow*. Waits while it is disabled or not finished loading, unless script role is `editorExtension`and it runs in the editor's main thread (then not invoke the command).
