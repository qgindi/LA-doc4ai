...
The `AddX` functions add data to the variable (not to the clipboard). Then `Au.clipboardData.SetClipboard` copies the added data to the clipboard. Also you can use the variable with `Au.clipboard.pasteData`.
The static`GetX` functions get data directly from the clipboard.
