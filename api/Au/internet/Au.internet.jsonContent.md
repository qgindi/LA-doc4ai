...
If *x* is string, creates/returns new `System.Net.Http.StringContent`.
Else if*x* is `System.Text.Json.Nodes.JsonNode` (or a derived type), calls `System.Text.Json.Nodes.JsonNode.ToJsonString` and creates/returns new `System.Net.Http.StringContent`.
Else if*x* is `System.Net.Http.HttpContent` (or a derived type), returns *x*.
Else calls/returns`System.Net.Http.Json.JsonContent.Create`.
