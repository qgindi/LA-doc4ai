...
- *source*  (`string`):
  File or URL to load. Supported element types and sources:
  `System.Windows.Controls.WebBrowser`, `System.Windows.Controls.Frame`- URL or file path.
  `System.Windows.Controls.RichTextBox` - path of a local `.rtf` file.
