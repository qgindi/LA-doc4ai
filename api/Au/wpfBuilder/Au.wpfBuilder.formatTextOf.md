# Method `Au.wpfBuilder.formatTextOf`
...
- *obj*  (`object`):
  ...
  - `RichTextBox`, `FlowDocumentScrollViewer` or `FlowDocumentReader` with non-`null` `Document`.
  - `FlowDocument`, `Paragraph`, `Span`
  - `InlineCollection`

  More info in `Au.wpfBuilder.FormatText` remarks.
...
- `NotSupportedException`:
  Unsupported *obj* type or content.
- `ArgumentException`:
