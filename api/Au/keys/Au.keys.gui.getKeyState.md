...
Can be used for mouse buttons too, for example`keys.gui.getKeyState(KKey.MouseLeft)`. When mouse left and right buttons are swapped, gets logical state, not physical.