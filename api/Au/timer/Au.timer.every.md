...
This thread must get/dispatch posted messages, eg call`Application.Run` or `Au.dialog.show`. The callback function is not called while this thread does not do it.