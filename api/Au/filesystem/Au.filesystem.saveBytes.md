# Method `Au.filesystem.saveBytes`
...
```csharp
public static void saveBytes(string file, ReadOnlySpan<byte> bytes, bool backup = false, string tempDirectory = null, int lockedWaitMS = 2000)
```
