...
- *items*  (`Au.Types.Strings`):
  Menu items, like `"One|Two|Three"` or `new("One", "Two", "Three")` or string array or `List`.
  Item id can be optionally specified like`"1 One|2 Two|3 Three"`, unless *rawText* `true`. If missing, uses id of previous non-separator item + 1. Example: `"One|Two|100 Three Four"`(1|2|100|101).
