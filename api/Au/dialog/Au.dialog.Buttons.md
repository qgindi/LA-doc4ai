...
- *buttons*  (`Au.Types.Strings`):
  List of button names or `"id name"`. Examples: `"OK|Cancel"`, `"1 Yes|2 No"`, `"1 &Save|2 Do&n't Save|0 Cancel"`, `["1 One", "2 Two"]`.
  Can contain common buttons (named**OK**, **Yes**, **No**, **Retry**, **Cancel**, **Close**) and/or custom buttons (any other names).
...
There are 6 *common buttons*: **OK**, **Yes**, **No**, **Retry**, **Cancel**, **Close**. Buttons that have other names are *custom buttons*.
