...
Static functions of `Au.perf`class use a single static variable of this type to perform measurements.
Use a variable of this type instead when you want to have multiple independent measurements. See`Au.perf.local`.
...
Don't need to dispose variables of this type. The`Au.perf.Instance.Dispose` function just calls `Au.perf.Instance.NW`.
