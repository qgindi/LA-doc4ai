...
Unlike `Au.wnd.Name`, this function prefers variable text, for example Edit control text, combo box selected item text, status bar text.
...
Calls`Au.wnd.GetText(true, false)`.
