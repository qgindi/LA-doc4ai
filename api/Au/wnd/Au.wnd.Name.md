...
Unlike`Au.wnd.ControlText`, this function usually does not get variable text, for example Edit control editable text, combo box control selected item text, status bar text.
Calls`Au.wnd.GetText(false, true)`.
