...
Creates new `Au.wndFinder` and calls `Au.wndFinder.IsMatch`.
To compare single parameter, use more lightweight code. Examples:`if (w.Name.Like("* Paint"))`, `if (w.ClassNameIs("CabinetWClass"))`.
