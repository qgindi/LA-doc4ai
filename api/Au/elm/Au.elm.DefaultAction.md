...
If this is a Java UI element, returns all actions that can be used with `Au.elm.JavaInvoke`, like `"action1, action2, action3"`, from which the first is considered default and is used by `Au.elm.Invoke`.
