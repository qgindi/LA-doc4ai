...
The`set` function sometimes can be used as a fast alternative to `Au.elm.Navigate`. It modifies only this variable. It does not check whether the value is valid.
