...
- *disposeOnExit*  (`bool`):
  Remove tray icon when process exits (`Au.process.thisProcessExit`).
  Note: can't remove if the process terminated or called`System.Environment.FailFast` or API `ExitProcess`.