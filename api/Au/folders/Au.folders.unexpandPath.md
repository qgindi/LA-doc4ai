...
For example if string is`"C:\Windows\System32\abc.exe"`, gets `"folders.System"` and `"abc.exe"`.
...
For example if string is`"C:\Windows\System32\abc.exe"`, returns `"%folders.System%\abc.exe"`.
