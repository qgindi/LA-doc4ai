...
*Wildcard expression* is a simple text format that supports wildcard characters, regular expression, "match case", "text1 or text2" and "not text". Used with "find" functions, for example `Au.wnd.find`.
...
| `r` | Text is PCRE regular expression (`Au.regexp`).<br>Syntax: [full](🔗), [short](🔗). | `"**r regex"` |
